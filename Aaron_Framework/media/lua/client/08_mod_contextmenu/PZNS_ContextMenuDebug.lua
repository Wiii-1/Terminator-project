...
function PZNS_ContextMenu.Debug.BuildOptions(mpPlayerID, context, worldobjects)
	...
	local submenu_1_Option = context:addOption(getText("ContextMenu_PZNS_PZNS_Debug_Build"), worldobjects, nil)
	...
	for debugKey, debugText in pairs(PZNS_DebugBuildText) do
		...
		--
		submenu_1:addOption(debugText, nil, callbackFunction)
	end
end
...
local function respawnTerminatorTester()
	PZNS_DeleteTerminatorTester(0)
	PZNS_SpawnTerminatorTester()
end
...
local PZNS_DebugWorldText = {
	...
	SpawnTerminator = getText("ContextMenu_PZNS_ReSpawn_Terminator_Tester"),
...
local PZNS_DebugWorld = {
	...
	SpawnTerminator = respawnTerminatorTester,
...
function PZNS_ContextMenu.Debug.WorldOptions(mpPlayerID, context, worldobjects)
	local submenu_1 = context:getNew(context)
	local submenu_1_Option = context:addOption(getText("ContextMenu_PZNS_PZNS_Debug_World"), worldobjects, nil)
...
function PZNS_ContextMenu.Debug.WipeOptions(mpPlayerID, context, worldobjects)
	local submenu_1 = context:getNew(context)
	local submenu_1_Option = context:addOption(getText("ContextMenu_PZNS_PZNS_Debug_WipeData"), worldobjects, nil)
	context:addSubMenu(submenu_1_Option, submenu_1)
	--
